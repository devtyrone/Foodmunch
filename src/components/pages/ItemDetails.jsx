...
const restaurantData = [
  { id: 1, name: 'fufu and Egusi with Chicken', desc: 'A savory West African dish featuring starchy fufu, rich egusi stew, and tender chicken!', img: '/src/assets/Foodlist/1.jpeg', price: 12.99, description_long: 'A perfect start to your day with our delicious Sunny Side Club sandwich, made with fresh ingredients and a rich sauce.' },
  { id: 2, name: 'Fufu and Egusi with Fish', desc: 'Premium Cocktails & Mocktails', img: '/src/assets/Foodlist/2.jpeg', price: 15.50, description_long: 'Indulge in our exquisite selection of premium cocktails and refreshing mocktails, crafted by expert mixologists.' },
  ...
  { id: 4, name: 'Shawama with chicken', desc: 'Delicious Late Night Cravings.', img: '/src/assets/Foodlist/4.jpeg', price: 11.25, description_long: 'Satisfy your late-night cravings with our selection of delicious and comforting meals, available exclusively after dark.' },
  ...
  { id: 6, name: 'Shawama with beef', desc: 'Delicious & Authentic Asian Flavours', img: '/src/assets/Foodlist/6.jpeg', price: 14.00, description_long: 'Dive into the delicious and authentic Asian flavors, from spicy curries to savory stir-fries, prepared with traditional recipes.' },
  { id: 7, name: 'jollof and CHICKEN', desc: 'Hot, cheesy, and loaded with toppings.', img: '/src/assets/Foodlist/7.jpeg', price: 18.00, description_long: 'Our Pizza Supreme is loaded with fresh vegetables, premium meats, and a generous layer of melted cheese on a perfectly baked crust.' },
