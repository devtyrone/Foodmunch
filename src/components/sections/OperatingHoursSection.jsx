    ...
    <section className="w-full bg-[#82afa8] py-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <div className="flex flex-wrap justify-center md:grid md:grid-cols-2 lg:grid-cols-3 xl:flex xl:flex-row xl:justify-center gap-4 text-white text-lg">
            {operatingHoursData.map((day, index) => (
              <div key={index} className="bg-[#82afa8] p-4 rounded-lg border border-gray-300 w-full md:w-auto xl:w-48">
